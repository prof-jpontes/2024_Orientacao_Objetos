        ...
        mainloop:do{
            ...
            switch (opcao) {
                ...
                case 2:
                    ...
                    System.out.print("CPF: ");
                    mapaConta.put(nConta, new Conta(agencia, nConta, mapaCliente.get(scanner.nextLine()))); //insere uma nova conta no mapa de contas. Observem que a referência ao cliente dono é obtida do mapa de clientes, com o seu CPF.
                    break;
                case 3:
